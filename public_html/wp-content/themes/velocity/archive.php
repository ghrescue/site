<?php
	...
	$pagecustoms = velocity_getOptions();
	...
	/*if ( function_exists( 'get_option_tree') ) {
		$velocity_archivelayout = get_option_tree( 'value_archivesidebar' );
		$velocity_bloglayout = get_option_tree( 'value_blogoverviewpostlayout' );
		$velocity_blogpostino = get_option_tree('value_blogoverviewpostinfo', '', false, true );
		$nopostinfo = "";
		...
		if(!is_array($velocity_blogpostino)){ $velocity_blogpostino = array(); $nopostinfo ="style='display:none;'"; }
	}*/
	...
	//Sidebar & Blog Style
	if(isset($pagecustoms["velocity_activate_sidebar"])){
		if (isset($pagecustoms["velocity_sidebar"])){$sidebar = $pagecustoms["velocity_sidebar"];}else{$sidebar = "Blog Sidebar";}
		$sidebar_orientation = $pagecustoms["velocity_sidebar_orientation"];
    ...
    if(!is_tax()){?>
        ...
        <?php //If this is the portfolio
                    ...
                    <div class="entry <?php //echo $velocity_categorylist; ?>">
						<div class="holderwrap">
							<div class="mediaholder">
								...
								<div class="cover"></div>
								<?php if($velocity_p_linkactive=="On"){ ?>  <a href="<?php echo $thelink; ?>" <?php echo $thetarget;?>><div class="link icon-forward '.$notalonemod.'"></div></a> <?php } ?>
            ...
            <?php if ($velocity_activate_sidebar=="on" && $sidebar_orientation =="right") { ?>
                ...
                <?php if(function_exists('velocity_pagination')){ echo'<div class="row" style="margin-top:40px;"></div>'; velocity_pagination(); }else{ paginate_links(); } ?>
            </div>
            <?php } else if ($velocity_activate_sidebar=="on" && $sidebar_orientation =="left") { ?>
            </div>
                <?php if(function_exists('velocity_pagination')){ echo'<div class="row" style="margin-top:40px;"></div>'; velocity_pagination(); }else{ paginate_links(); } ?>
