...
<section class="row">
    ...
    <!--section class="row <?php echo $velocity_display_span; ?> portfoliowrap"-->
        ...
        <ul class="portfoliofilter clearfix">
            <?php
				if($velocity_all!="" ){ echo '<li><a class="selected" data-filter="*" href="#">'.$velocity_all.'</a><span></span></li>'; }
				if(is_array($velocity_tax_terms)){
					foreach ( $velocity_tax_terms as $velocity_tax_term ) {
						$velocity_filter_last_item = end($velocity_tax_terms);
						if($velocity_tax_term!=$velocity_filter_last_item){
							echo '<li style="display:none" id="'.$velocity_tax_term->slug.'"><a data-filter=".'.$velocity_tax_term->slug.'" href="#">'.$velocity_tax_term->name.'</a><span></span></li>';
						}else{
							echo '<li style="display:none" id="'.$velocity_tax_term->slug.'"><a data-filter=".'.$velocity_tax_term->slug.'" href="#">'.$velocity_tax_term->name.'</a></li>';
						}
					}
				}
			?>
    ...
    <div class="row <?php echo $display_span; ?> portfoliowrap foliooverview" >
        ...
        <div class="portfolio <?php echo $velocity_display_span; ?> <?php echo $velocity_withsidebarmod; ?>">
			...
			$velocity_args=array(
				...
				'posts_per_page' => $velocity_portfolio_items,
