...
<?php
	...
	$velocity_themeoptions['velocity_blogoverviewpostlayout'] = "Small Media";
	unset($velocity_themeoptions['velocity_blogoverviewsingledate']);
	$velocity_themeoptions['velocity_blogoverviewpostinfo_date'] = 'on';
	$velocity_themeoptions['velocity_blogoverviewpostinfo_author'] = 'on';
	$velocity_themeoptions['velocity_blogoverviewpostinfo_category'] = 'on';
	unset($velocity_themeoptions['velocity_blogoverviewpostinfo_comments']);
	unset($velocity_themeoptions['velocity_blogoverviewpostinfo_tags']);
	$velocity_themeoptions['velocity_blogoverview_excerpt'] = 55;
						...
						while($velocity_all_posts->have_posts() && $velocity_postcounter <= $velocity_posts_per_page) : $velocity_all_posts->the_post();
							...
							switch ($velocity_postcustoms["velocity_post_type"]) {
								...
								case 'video':
									...
									$velocity_video_width = $velocity_postcustoms["themetastic_video_width"];
									$velocity_video_height = $velocity_postcustoms["themetastic_video_height"];
